...
$allowed_hosts = array('http://10.35.0.235/ora/php/auth.php');
$referer = $_SERVER['HTTP_REFERER'];
if (!isset($_SERVER['HTTP_HOST']) || !in_array($_SERVER['HTTP_REFERER'], $allowed_hosts)) {

	if (strpos($referer,'http://10.35.0.235/ora/php/admin_user.php?admin=') !== false) {
	} else {
...
$result = mysql_query("SELECT user_login,user_pass,user_firstname,user_lastname,is_admin,Director,last_login,vacation,vacation_used,personal_time,user_email,Company FROM users WHERE user_login='" . $user . "' LIMIT 1");
